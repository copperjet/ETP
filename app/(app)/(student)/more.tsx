  ...
  const sections: { title: string; items: MenuItem[] }[] = [
    {
      ...
      items: [
        ...
        { icon: 'calendar-outline', label: 'Timetable', sublabel: 'My class schedule', onPress: () => router.push('/(app)/(student)/timetable' as any) },
      ],
    },
    {
      title: 'Notifications',
        ...
        <SafeAreaView edges={['top']} style={{ backgroundColor: colors.brand.primary }}>
          <View style={styles.hero}>
            <View style={styles.heroAvatarRow}>
              <Avatar name={user?.fullName ?? 'S'} size={70} />
              <View style={styles.heroText}>
                ...
                <View style={styles.rolePill}>
                  <ThemedText style={styles.rolePillText}>STUDENT</ThemedText>
                </View>
              </View>
            </View>
            {school && (
