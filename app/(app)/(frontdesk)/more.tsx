...
import { View, StyleSheet, ScrollView, Alert, Linking, TouchableOpacity, StatusBar, Platform } from 'react-native';
  ...
  return (
    ...
    >
      ...
      <View style={styles.menuText}>
        <ThemedText style={{ fontSize: 15, fontWeight: '500', color: item.danger ? '#EF4444' : colors.textPrimary }}>{item.label}</ThemedText>
        ...
        <SafeAreaView edges={['top']} style={{ backgroundColor: colors.brand.primary }}>
          <View style={styles.hero}>
            <View style={styles.heroRow}>
              <Avatar name={user?.fullName ?? 'F'} size={70} />
              <View style={styles.heroText}>
                ...
                <View style={styles.rolePill}>
                  <ThemedText style={styles.rolePillText}>FRONT DESK</ThemedText>
                </View>
              </View>
            </View>
            {school && (
